...
def transform_data():
    ...
    def get_images(root_path):
        train_images = glob.glob(f"{root_path}/jpg_images/*")
        #print("===",train_images)
        train_images.sort()
        train_masks = glob.glob(f"{root_path}/masks/*")
        train_masks.sort()
        #print("====",train_masks)
        valid_images = glob.glob(f"{root_path}/jpg_images/*")
        valid_images.sort()
    ...
    train_images, train_masks, valid_images, valid_masks = get_images(os.path.join(os.getcwd()))    
